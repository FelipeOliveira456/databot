...
# def get_schema_judger():
#     parser = CleanThinkParser(pydantic_object=RelevantSchema)

#     system_prompt = """
#     Sua tarefa é decidir se um trecho de schema de banco de dados é relevante para responder à pergunta do usuário.

#     Responda **apenas** com um JSON válido no seguinte formato:

#     {{
#         "relevant": "sim"  # use exatamente "sim" ou "nao"
#         "explain": "Explique brevemente por que o schema é ou não relevante."
#     }}

#     Não inclua explicações, comentários, texto extra ou qualquer outro conteúdo fora desse JSON.

#     Reflita antes de responder e entregue somente esse JSON.

#     Nota importante:  
#     Uma tabela pode ser considerada relevante mesmo que não contenha diretamente todos os campos necessários para responder à pergunta,  
#     pois pode servir como base para outras tabelas através de chaves estrangeiras (relacionamentos). Portanto, avalie a relevância considerando essas relações.
#     """
...
#     chain = prompt | ChatOllama(model="qwen2.5-coder:14b", temperature=0.7, top_p=0.80, top_k=20, repeat_penalty=1.05) | parser
